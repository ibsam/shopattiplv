                            ...
                            <div class="card-info">
                                <div class="card-body">
                                    <div class="product-title font-w-5">
                                        <a v-bind:href="'/'+item.url_name+'_'+item.id+'.htm'"><p class="link-title">{{item.name}}</p></a>
...
<!--                                        <button class="btn-cart btn btn-pink mx-3" type="button"><i class="las la-shopping-cart mr-1"></i> Add to cart </button>-->
                ...
                <infinite-loading
                    ...
                    <div slot="spinner"><img src="/images/tipmartlogo.png"></div>

                    <div slot="no-more"><h4>For More Products Explore From Categories</h4><a href="/tipmart"><img src="/images/tipmartlogo.png"></a></div>
                </infinite-loading>
            </div>
        </div>
    </div>
