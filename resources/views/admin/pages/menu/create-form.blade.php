      ...
      <div class="col-12">
          <div class="card">
              ...
              <div class="card-content">
                  <div class="card-body">
                  <form class="form" method="POST" action="{{route('menu.store')}}" enctype="multipart/form-data">
                    @csrf
                              ...
                              <div class="row">
                                ...
                                <div class="demo-inline-spacing">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="General" value="1" name="menu_type_id" class="custom-control-input" checked="">
                                        <label class="custom-control-label" for="General">General</label>
                                    </div>
                                    <div class="custom-control custom-control-success custom-radio">
                                        <input type="radio" id="Groccery" value="2" name="menu_type_id" class="custom-control-input" >
                                ...
                                @endif
                                  ...
                                  <div class="col-12">
                                    ...
                                    form-group position-relative has-icon-left">
                                      ...
                                      id="destination_url" placeholder="Link" required=""/>
                                      <div class="form-control-position">
