  ...
  <div class="card">
    <div class="card-content">
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-12">
          <a href="{{ route('campaign.create')}}" class="float-right">
            ...
            <table class="table table-striped table-bordered" style="width:100%" id="users-table">
              <thead>
                  <tr>
                      ...
                      <th>Name</th>
                      <th>Slug</th>
                      <th>Product Price Start</th>
                      <th>Product Price End</th>
                      <th>Start Date</th>
                      <th>End Date</th>
                      <th>Action</th>
                  </tr>
...
@section('page-script')
        {{-- Page js files --}}
        <script src="{{ asset(mix('js/scripts/pages/campaign.js')) }}"></script>
@endsection
