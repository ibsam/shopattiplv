                              ...
                              <div class="row">
                                ...
                                <div class="demo-inline-spacing">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="General" value="1" name="category_type_id" class="custom-control-input" {{($category->category_type_id==1) ? "checked" :''}}/>
                                ...
                                <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                    <img src="{{ asset('uploads/category_image/') }}/{{ $category->logo }}" id="displayHere" alt="" width="250" height="">
                                            </div>
                                        </div>
