  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-lg-7">
        ...
        @endif
        <form class="row" method="post" action="/contact-us" novalidate="true">
           @csrf
            <div class="messages"></div>
            <div class="form-group col-md-6">
              <label>First Name <span class="text-danger">*</span></label>
              <input id="form_name" type="text" name="first_name" class="form-control" placeholder="First Name" required="" data-error="Name is required.">
              <div class="help-block with-errors"></div>
            </div>
            <div class="form-group col-md-6">
              <label>Last Name <span class="text-danger">*</span></label>
              <input id="form_name1" type="text" name="last_name" class="form-control" placeholder="Last Name" required="" data-error="Name is required.">
              <div class="help-block with-errors"></div>
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="col-md-12 mt-4">
              <button type="submit" class="btn btn-primary btn-animated"><span>Submit</span>
              </button>
            </div>
        </form>
      </div>
      <div class="col-lg-5 mt-6 mt-lg-0">
        ...
        <div class="d-flex mb-4 border-bottom pb-4">
          ...
          <div>
            ...
            <p class="mb-0">E-99 Block-B Gulshan-e-Jamal Karachi Pakistan</p>
          </div>
        </div>
        <div class="d-flex mb-4 border-bottom pb-4">
